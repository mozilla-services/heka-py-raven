...
included test suite.  ::
    ...
    {u'env_version': u'0.8',
     u'fields': {u'epoch_timestamp': 1336490211.8597479},
     u'logger': u'some_logger_name',
...
Metlog adds a single 'epoch_timestamp' key into the 'fields'
dictionary so that logstash can properly record the time that the
...
data, but this is currently not supported in metlog-raven.
